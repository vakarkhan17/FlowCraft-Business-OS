...
| FCSB-014 | [Finance Solution Architecture](./FCSB-Volume-14-Finance-Solution-Architecture.md) | 1.0 Draft | Architecture Review Draft | DBA-002 Platform Foundation; DBA-003 Enterprise Structure; DBA-004 Enterprise Master Data; finance architecture gate before Inventory, Sales, Procurement, Manufacturing and accounting implementation | Pending Architecture Board, Finance, Tax, Treasury, Data Governance, Security, Internal Audit, Inventory, Procurement, Sales, Manufacturing, Projects, Payroll, Integration, Reporting and Operations Review | 2026-07-16 | FCSB-001 through FCSB-013; current company/organization, currency/exchange-rate, customer/supplier, payment/credit/tax master, chart-account/journal scaffold, transaction, workflow, number-series, EOR, audit, Digital DNA, report/dashboard, test, migration, dependency, and deployment evidence |
| FCSB-015 | [Inventory and Warehouse Architecture](./FCSB-Volume-15-Inventory-and-Warehouse-Architecture.md) | 1.0 Draft | Architecture Review Draft | DBA-002 Platform Foundation; DBA-003 Enterprise Structure; DBA-004 Enterprise Master Data; inventory architecture gate before DBA-006 Inventory Ledger and Sales, Procurement, Manufacturing Execution, Quality, Maintenance, Mobile and warehouse-runtime implementation | Pending Architecture Board, Inventory, Warehouse, Supply Chain, Finance, Procurement, Sales, Manufacturing, Quality, Maintenance, Security, Data Governance, Reporting, Integration, Operations and Internal Audit Review | 2026-07-17 | FCSB-001 through FCSB-014; current Item/UOM, warehouse/zone/bin, batch/serial, stock-status, organization, transaction/workflow, EOR, audit, Digital DNA, report/dashboard, test, migration, dependency, and deployment evidence; no accepted inventory ledger or warehouse-execution runtime |
| FCSB-016 | [Sales and Customer Architecture](./FCSB-Volume-16-Sales-and-Customer-Architecture.md) | 1.0 Draft | Architecture Review Draft | DBA-002 Platform Foundation; DBA-003 Enterprise Structure; DBA-004 Enterprise Master Data; Sales architecture gate before opportunity-to-cash, pricing, credit, fulfillment, billing, returns, portal and channel implementation | Pending Architecture Board, Sales, Customer Service, Finance, Credit Control, Inventory, Warehouse, Manufacturing, Procurement, Tax, Data Governance, Security, Integration, Reporting, Operations and Internal Audit Review | 2026-07-17 | FCSB-001 through FCSB-015; current BusinessPartner/Customer, address/contact, credit/payment/delivery terms, PriceList/tax/currency, Item/UOM, organization, transaction/workflow, EOR, audit, Digital DNA, report/dashboard, test, migration, dependency and deployment evidence; no accepted operational Sales runtime |
| FCSB-017 | [Procurement and Supplier Architecture](./FCSB-Volume-17-Procurement-and-Supplier-Architecture.md) | 1.0 Draft | Architecture Review Draft | DBA-002 Platform Foundation; DBA-003 Enterprise Structure; DBA-004 Enterprise Master Data; Procurement architecture gate before source-to-pay, supplier governance, sourcing, requisition, purchase-order, receipt coordination, matching, returns, portal and channel implementation | Pending Architecture Board, Procurement, Supplier Management, Finance, Accounts Payable, Inventory, Warehouse, Quality, Manufacturing, Maintenance, Projects, Tax, Data Governance, Security, Integration, Reporting, Operations and Internal Audit Review | 2026-07-18 | FCSB-001 through FCSB-016; current BusinessPartner/Supplier, supplier-group/address/contact, payment/credit/delivery terms, currency/exchange-rate, tax, Item/UOM/replenishment, organization, generic transaction/workflow, EOR, number-series, audit, Digital DNA, report/dashboard, test, migration, dependency and deployment evidence; no accepted operational Procurement runtime |
| FCSB-018 | [Manufacturing Execution Architecture](./FCSB-Volume-18-Manufacturing-Execution-Architecture.md) | 1.0 Draft | Architecture Review Draft | DBA-002 Platform Foundation; DBA-003 Enterprise Structure; DBA-004 Enterprise Master Data; Manufacturing Execution architecture gate before production orders, dispatch, material coordination, labor/machine capture, completion, genealogy, costing, shop-floor devices and MES implementation | Pending Architecture Board, Manufacturing, Production Planning, Inventory, Warehouse, Quality, Maintenance, Finance, Cost Accounting, Procurement, Sales, Engineering, Data Governance, Security, Integration, Reporting, Operations and Internal Audit Review | 2026-07-18 | FCSB-001 through FCSB-017; current Item/UOM, manufacturing/tracking/quality/subcontract flags, plant/warehouse/bin, batch/serial/stock-status, cost/profit-center, generic transaction/workflow, production EOR, number-series, audit, Digital DNA, report/dashboard, test, migration, dependency and deployment evidence; no accepted operational Manufacturing Execution runtime |

**Next planned volume:** FCSB-019 — Quality Management Architecture.
...
| 14 | FCSB-014 | Finance Solution Architecture | General ledger, subledgers, posting, tax, treasury, assets, close, and financial controls | Drafted — Architecture Review Draft |
| 15 | FCSB-015 | Inventory and Warehouse Architecture | Inventory ledger, movements, reservations, availability, valuation, traceability, and warehouse execution | Drafted — Architecture Review Draft |
| 16 | FCSB-016 | Sales and Customer Architecture | Opportunity-to-cash processes, pricing, order fulfillment, billing, returns, and customer controls | Drafted — Architecture Review Draft |
| 17 | FCSB-017 | Procurement and Supplier Architecture | Source-to-pay processes, supplier governance, purchasing, receiving, invoicing, and controls | Drafted — Architecture Review Draft |
| 18 | FCSB-018 | Manufacturing Execution Architecture | Production orders, dispatch, material issue, labor, completion, genealogy, and shop-floor execution | Drafted — Architecture Review Draft |
| 19 | FCSB-019 | Quality Management Architecture | Quality planning, inspection, holds, nonconformance, corrective action, and traceability | Planned |
